...
namespace NUnit.page
{
    ...
    public class AddSessionTest
    {
        ...
        [Test]
        public void NUnitfilmValid_InCorrectValue_EmptyFieldReturnNull()
        {
            List<TextBox> txtList = new List<TextBox>();
            List<DateTimePicker> dateList = new List<DateTimePicker>();
        ...
        [Test]
        public void NUnitfilmValid_InCorrectValue_EmptyNameReturnNull()
        {
            initialize();
            txtList[0].Text = "";
            Assert.IsNull(add.filmValid(txtList, dateList, filmList));
        ...
        [Test]
        public void NUnitfilmValid_InCorrectValue_EmptyDataReturnNotNull()
        {
            initialize();
            filmList.Clear();
        ...
        [Test]
        public void NUnitfilmValid_CorrectValue_NoRepeatReturnNotNull()
        {
            initialize();
            Assert.IsNotNull(add.filmValid(txtList, dateList, filmList));
        }
        ...
        [Test]
        public void NUnitfilmValid_InCorrectValue_RepeatReturnNull()
        {
            initialize();
            Film f = new Film();
            f.Name = "Дедпул";
